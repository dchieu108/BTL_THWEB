...
<head>
    ...
    <link rel="stylesheet" href="../Css/curron_male.css">
...
<body>
    ...
    <section>
         <!-- start banner -->
         <div class="banner-male">
            <div class="banner-1 ">
                <div class="image-banner  ">
                    <img  class="w-100" src="..//Images/vo_ng_nu_.webp" alt=""  >
     ...
     <div class="product-men">
        ...
        <div class="list-product d-flex w-75">
           
        </div>
    </div>

     <!-- -----end List curron male----- -->

    <div class="male-media d-flex w-70">
        <div class="media-item">
           <img  width="556" height="360" src="../Images/Artboard_2_2_326cd34354.webp" alt="">
        </div>
       
        <div class="media-title">
            <h2>MIX & MACTH</h2>
            <h5>PHỤ KIỆN</h5>
            <p>Khẳng định cá tính, phong cách của bản thân với những phụ kiện không thể thiếu từ Curnon</p>
    ...
    <script src="../Js/vongtay.js"></script>
