    ...
    <section>
        ...
        <div class="product-men ">
            <div class="product-title text-center">
                ...
                <!-- <p class="font-15"> XEM TẤT CẢ <i class="fa-solid fa-arrow-right "></i></p> -->
            </div>
            <div class="list-product d-flex w-70">
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <a href="..//View/chitietsanpham.php"><div><img src="../Images/galant.webp" class="w-100" alt="cate"></div></a>
                    ...
                    <div class="product-name text-center">
                        ...
                        <h3>VARY</h3>
                        <p>
                            <span class="fw-900">2.069.000</span>
                            <span class="text-through">2.299.000</span>
                        </p>
                    </div>
                ...
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/web_-_thunderbolt_du_1.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>JACKSON</h4>
                        <h3>TOLY</h3>
                        <p>
                            <span class="fw-900">3.769.000</span>
                            <span class="text-through">5.960.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/1_black5.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>KASHMIR</h4>
                        <h3>HUNK</h3>
                        <p>
                            <span class="fw-900">1.069.000</span>
                            <span class="text-through">1.390.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/haze.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>JACKSON</h4>
                        <h3>BALY</h3>
                        <p>
                            <span class="fw-900">1.320.000</span>
                            <span class="text-through">2.690.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/charm.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>MOONSTARE</h4>
                        <h3>AURORA</h3>
                        <p>
                            <span class="fw-900">1.760.000</span>
                            <span class="text-through">2.360.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/lace.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>CITRINE</h4>
                        <h3>POTENT</h3>
                        <p>
                            <span class="fw-900">4.890.000</span>
                            <span class="text-through">5.390.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/serene.webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>MASSIMO</h4>
                        <h3>GARI</h3>
                        <p>
                            <span class="fw-900">3.650.000</span>
                            <span class="text-through">4.500.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
                <div class="product-item w-25 position-rel ">
                    <div class="product-cate position-rel">
                        <div><img src="../Images/wind (1).webp" class="w-100" alt="cate"></div>
                        <div class="product-sale">20%</div>
                    </div>
                    <div class="product-name text-center">
                        <h4>VARY</h4>
                        <h3>SICILY</h3>
                        <p>
                            <span class="fw-900">1.790.000</span>
                            <span class="text-through">2.100.000</span>
                        </p>
                    </div>
                    <button>Thêm giỏ hàng</button>
                </div>
