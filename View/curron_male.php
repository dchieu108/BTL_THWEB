...
<body>
    ...
    <section>
         ...
         <div class="banner-male">
            <div class="banner-1 ">
                <div class="image-banner  ">
                    <img class="w-100" src="../Images/collection_nam.webp" alt="">
     ...
     <div class="product-men">
        <div class="product-title " >
            <h1 style="text-align: left;">ĐỒNG HỒ NAM</h1>
            <div>
    ...
    <div class="male-media d-flex w-70">
        ...
        <div class="media-title">
            ...
            <div><button>KHÁM PHÁ NGAY</button></div>
        </div>
    </div>
    ...
    <script src="../Js/curron_male.js"></script>
